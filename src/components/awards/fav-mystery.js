...
import Silence from '../images/silence-of-the-lambs.jpeg';

export default function FavMystery() {
    return (
        <section>
            <header>
                <div className='menu'>
            ...
            <main>
                <div className="awards">
                    <h3 style={{ marginBottom: "40px", textAlign: "center" }}>Readers' Favorite Mystery and Thriller Books</h3>
                    <Row>
                        <Col sm={4}>
                        ...
                        <Col sm={4}>
                            <Card style={{ textAlign: "center" }}>
                                ...
                                <Card.Body>
                                    <Link to="/not-found">
                                        <Image src={Silence} style={{ height: "400px" }} />
                                    </Link>
                                </Card.Body>
                                <Card.Footer>
                                    <h6>Thomas Harris</h6>
